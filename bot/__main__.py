...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, anime, search, delete, speedtest
from bot import BLOCK_MEGA_LINKS, BLOCK_MEGA_FOLDER, BANDWIDTH_LIMIT, MAX_TORRENT_SIZE
@run_async
def stats(update, context):
    ...
    stats = f'<b>🔁 Bot Uptime 🔁\n</b> \n「 {currentTime} 」\n\n' \
            ...
            f'<b>🔻 Down:</b> {recv}\n' \
            f'<b>\n⚠ Limited:</b>\n' \
            f'<b>Transfer limit:</b> <i><b>{BANDWIDTH_LIMIT}TB</b></i>\n' \
    ...
    update.effective_message.reply_photo("https://telegra.ph/file/691ab581d5361de0428d5.jpg", stats, parse_mode=ParseMode.HTML)
...
'''
    update.effective_message.reply_photo("https://telegra.ph/file/3dab31a43ba92d7312c82.jpg", start_string, parse_mode=ParseMode.MARKDOWN)
